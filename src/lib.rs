//! Read location databases in
//! [libloc](https://www.ipfire.org/projects/location/) format.
//!
//! It features constant-time lookups of IPv6/IPv4 addresses to [ASN] and
//! country data (["GeoIP"]). The database also contains names of [AS] and
//! countries.
//!
//! **The main struct of this crate is [`Locations`]**. First, you'll need a
//! database. A recent version of the official IPFire database can be obtained
//! from <https://location.ipfire.org/databases/1/location.db.xz>,
//! xz-compressed. Then you can start from [`Locations::open`] and use
//! [`Locations::lookup`] to look up information on a particular IP address.
//!
//! A short overview about the internals of the database format can be found at
//! <https://www.ipfire.org/blog/libloc-or-what-is-working-inside-it>.
//!
//! # Examples
//!
//! ```
